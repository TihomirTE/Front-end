namespace FurnitureManufacturer.Engine.Factories
{
    ...
    public class FurnitureFactory : IFurnitureFactory
    {
        ...
        {
            return new Table(model, GetMaterialType(materialType),
        ...
        {
            return new AdjustableChair(model, GetMaterialType(materialType), price,
                                        height, numberOfLegs);
        }
        ...
        {
            return new ConvertableChair(model, GetMaterialType(materialType), price, height, numberOfLegs);
        }
