...
namespace Entity_Framework.Nortwind
{
    ...
    public partial class NorthwndEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> usp_GetFullNames()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("usp_GetFullNames");
        }
    
        public virtual ObjectResult<usp_GetMoney_Result> usp_GetMoney(Nullable<decimal> currentMoney)
        {
            var currentMoneyParameter = currentMoney.HasValue ?
                new ObjectParameter("currentMoney", currentMoney) :
                new ObjectParameter("currentMoney", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetMoney_Result>("usp_GetMoney", currentMoneyParameter);
        }
    
        public virtual int usp_InsertForeignKeyToCity2(string table)
        {
            var tableParameter = table != null ?
                new ObjectParameter("table", table) :
                new ObjectParameter("table", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_InsertForeignKeyToCity2", tableParameter);
        }
    
        public virtual int usp_PersonalInterestRateForOneMonth(Nullable<int> accountId, Nullable<decimal> intersetRate)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("accountId", accountId) :
                new ObjectParameter("accountId", typeof(int));
    
            var intersetRateParameter = intersetRate.HasValue ?
                new ObjectParameter("intersetRate", intersetRate) :
                new ObjectParameter("intersetRate", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_PersonalInterestRateForOneMonth", accountIdParameter, intersetRateParameter);
        }
    }
}
