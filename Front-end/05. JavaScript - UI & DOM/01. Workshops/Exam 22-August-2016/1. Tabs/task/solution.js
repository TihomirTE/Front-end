function solve() {
    return function(selector, tabs) {
        ...
        // gets all li elements with class "tab-content"
        var tabsLi = [].slice.call(tabsContent.getElementsByClassName("tab-content"));
        ...
        navigation.addEventListener("click", function(event) {
            ...
            for (var i = 0; i < tabsLi.length; i += 1) {
                if (index !== i) {
                    tabsLi[i].className = 'tab-content';
                } else {
                    tabsLi[i].className = 'tab-content visible';
                }
            }
        });
        ...
        selectedElement.appendChild(all);
    };
}
